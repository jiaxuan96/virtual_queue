                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      StreamBuilder<DocumentSnapshot>(
                                          ...
                                          int current = 48; // Baseline fallback value matching mockup target
                                          if (snapshot.hasData && snapshot.data!.exists) {
                                            var d = snapshot.data!.data() as Map<String, dynamic>;
                                            current = d['current_serving'] ?? 48;
                                          }
                                          return Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                    ...
                                    children: [
                                      ...
                                      StreamBuilder<DocumentSnapshot>(
                                        ...
                                        builder: (context, snapshot) {
                                          int queueLength = 6; // Baseline fallback value matching mockup target
                                          if (snapshot.hasData && snapshot.data!.exists) {
                                            var d = snapshot.data!.data() as Map<String, dynamic>;
                                            queueLength = d['queue_length'] ?? 6;
                                          }
